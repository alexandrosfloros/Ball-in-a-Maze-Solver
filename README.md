...
This is a simulation of an autonomous ball-in-a-maze puzzle solution algorithm. It was designed as part of an overall system, using a combination of software and hardware, that aims to sucessfully solve the puzzle by tilting the board and hence moving the ball through the maze, whilst avoiding any obstacles.
